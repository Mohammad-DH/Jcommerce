...
export async function AddFullUserAsync(FirstName, LastName, PhoneNumber, Email, Admin, Code) {
...
export async function UpdateUserAsync(User) {
    ...
    const { User_Id, FirstName, LastName, PhoneNumber, Email, Admin, Code } = User
